...
<title>Direct Publish Link</title>
    ...
    <script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/viewmodels/directpublishlink.viewmodel.js' defer="defer"></script>
    <script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/page/directpublishlink.page.js' defer="defer"></script>
            ...
            <div id="hades">                
                <div class="row-fluid">
                  <div class="span12 text-center">    
                        ...
                        <div class="row-fluid">
                            <h5>Direct Publish Link</h5><br/><br/>
                        </div>
                  </div>
                </div>
                <div class="row-fluid">
