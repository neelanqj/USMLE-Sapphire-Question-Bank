...
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
	<title>Question Edit Mode</title>
    ...
    <!-- Custom Script -->
	<script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/viewmodels/questioneditmode.viewmodel.js' defer></script>
	<script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/page/questioneditmode.page.js' defer></script>
...
<body>
	...
	<div id="questions_frame">
        ...
        <div id="question_body">
            ...
            <hr/>
            <ul data-bind="foreach: questionanswertext">
            	<li>
                    <input type="checkbox" name="answers" data-bind="checked: $parent.questionanswers, value: questionanswersid, enable: !$parent.lockStatus(), click: $parent.setAnswer" /><span data-bind="text: answer"></span>
                </li>
            </ul>
        </div>
        ...
        <div id="footer-quiz" class="controlFrame">
            ...
            <div id="stop-icons" class="rfloat">
                <img data-bind="click: endBlockModal" class="fade" src="../../src/custom/img/icon/exit-icon.png" />
            </div>
            <div id="lock-icons" class="center">
                <img class="fade" data-bind="click: setLock, attr: { class: lockStatus()? '':'greyout' }" src="../../src/custom/img/icon/edit-icon.png" />
            </div>
        </div>
    </div>
