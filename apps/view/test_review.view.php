...
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
	<title>Le Test Review BOSS</title>
    ...
    <!-- Custom Script -->
	<script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/viewmodels/test_review.viewmodel.js' defer></script>
	<script language="JavaScript" type="text/javascript" src='../../src/custom/js/apps/page/test_review.page.js' defer></script>
...
<body>
	<div id="pages_frame">
    	<ul data-bind="foreach: questionStatusArray()">
                <button data-bind="click: $parent.getQuestion, text: index
	...
	<div id="questions_frame">
        <div id="header" class="controlFrame">
            ...
            <div id="flagquestion" class="lfloat">
                <input type="checkbox" disabled/> <img src="../../src/custom/img/icon/redflag-icon.png" /> Flag
            </div>
        ...
        <div id="question_body">
            ...
            <img data-bind="attr: { src: (questioncorrect() == '1')? '../../src/custom/img/correct.png' : '../../src/custom/img/wrong.png' }"> 
            You got this question <span data-bind="text:(questioncorrect() == '1')?'correct':'wrong'"></span> during the test.
            <br/><br/>
			<span data-bind="html: questiontext" ></span><br/><br/>
            </div>
            <hr/>
            ...
            <hr/>
            <span class="bold">Answer (Click Answer for your Historical Answer &amp; the Real Answer. Use the check boxes to test your knowledge.)</span><br/>
            <div data-bind="foreach: questionanswertext">            
                <div class="accordion">
                  <div class="accordion-group">
                    <div class="accordion-heading">
                        <a href="#" class="accordion-toggle collapsed" data-toggle="collapse" 
                        data-bind="html: answer 
                        , attr: { 'data-target':'#ans' + questionanswersid }"></a>
                    </div>
                    
                    <div class="collapse backgroundwhite" data-bind="attr: { id:'ans' + questionanswersid }">
                        <div class="accordion-inner">
                            <img data-bind="attr: { src : (correctchecked == '1')? '../../src/custom/img/correct.png': '../../src/custom/img/wrong.png' }"> <input type="checkbox" data-bind="checked: (checked == '1') ? true : false" disabled /> You got this answer <span data-bind="text: (correctchecked == '1') ? 'correct': 'wrong'"></span> during the test<br/>
                            
                            <input type="checkbox" data-bind="checked: (correct == '1') ? true : false" disabled />
                            It was supposed to be <span data-bind="text: (correct == '1') ? 'checked': 'unchecked'"></span>
                            <br/><br/>
                            
                            <b>Explaination:</b><br/>
                                <span data-bind="html: answerexplaination"></span>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Are You Sure You Want To End The Review?</h4>
          </div>
          <div class="modal-body">
          	When you leave you can always come back by checking your test history.
          </div>
